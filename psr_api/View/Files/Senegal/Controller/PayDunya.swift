...
protocol PayDunyaDelegate: class
{
    func paymentWithPD(tel: String, code: String)
}

class PayDunya: UIView
{
    ...
    @IBAction func payWithPayDunyaButton(_ sender: UIButton)
    {
        ...
        delegate.paymentWithPD(tel: telTextField.text!, code: codeTextField.text!)
    }
    
    //MARK: Properties
    
    weak var delegate: PayDunyaDelegate? = nil
